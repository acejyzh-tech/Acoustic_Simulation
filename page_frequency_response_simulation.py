...
with curvebox.container():
    ...
    with tab4:
        data_all = pd.merge(Sensitivity, Noise, on="Freq", suffixes=("_sens", "_noise"))
        data_all = pd.merge(data_all, Phase, on="Freq", suffixes=("_sens", "_noise"))
